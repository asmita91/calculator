...
e= Entry(root, width=40,textvariable = input_text, borderwidth=8)
...
button_subtract= Button(root, text="-", padx=39, pady=20,  command = lambda: button_click("-"))
button_multiply= Button(root, text="*", padx=39, pady=20,  command = lambda: button_click("*"))
